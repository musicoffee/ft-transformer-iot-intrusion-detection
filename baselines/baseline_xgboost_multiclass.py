...
# =========================================================
# 放到：baselines/baseline_xgboost_multiclass.py
# 用法：在 PyCharm 里直接点绿色三角运行
# 任务：CICIoT2023 多分类 XGBoost 基线
# =========================================================
...
REPORT_JSON = OUTPUT_REPORT_DIR / "baseline_xgboost_multiclass_metrics.json"
REPORT_TXT = OUTPUT_REPORT_DIR / "baseline_xgboost_multiclass_classification_report.txt"
CM_PNG = OUTPUT_FIGURE_DIR / "baseline_xgboost_multiclass_confusion_matrix.png"
...
def main() -> None:
    ...
    print(f"XGBoost multiclass train shape: {x_train.shape}")
    print(f"XGBoost multiclass test shape: {x_test.shape}")
    ...
    print("XGBoost multiclass metrics:", metrics)
    print(f"XGBoost multiclass metrics saved to: {REPORT_JSON}")
    print(f"XGBoost multiclass report saved to: {REPORT_TXT}")
    print(f"XGBoost multiclass confusion matrix saved to: {CM_PNG}")
